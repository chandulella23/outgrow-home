...
@section('content')
	...
	<section class="section section-bg-btn">
		<div class="col-md-12 col-sm-12 col-xs-12 np text-center">
			<a target="_blank" href="https://app.outgrow.co/signup?utm_source=website&utm_medium=link&utm_campaign=outgrow_ROI_page" class="params trialLOL">
		...
		<div class="container">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="col-md-10 col-sm-10 col-xs-12">
					...
					<img class="rs-show" src="images/lp-section-six-img_increase-roi.png" alt="lp-section-six-img_increase-roi image"> 
					<!-- <ul>
				...
				<img class="rs-hide" src="images/lp-section-six-img_increase-roi.png" alt="lp-section-six-img_increase-roi image"> 
			</div>
		</div>
	</section>
	...
	<section class="section section-reading">
		<div class="container">
			...
			<div class="col-md-12 col-sm-12 col-xs-12 np">
				...
				<div class="col-md-4 col-sm-4 col-xs-12 np reading-block">
					<div class="img-scaler">
						<img src="images/lp-reading2_increase-roi.png" alt="lp-reading2_increase-roi image"> 
					</div>
					<div class="col-md-12 np reading-content">
				...
				<div class="col-md-4 col-sm-4 col-xs-12 np reading-block">
					<div class="img-scaler">
						<img src="images/lp-reading3_increase-roi.png" alt="lp-reading3_increase-roi image"> 
					</div>
					<div class="col-md-12 np reading-content">
