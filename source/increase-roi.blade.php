		...
		<div class="container">
			...
			<div class="col-md-12 col-sm-12 col-xs-12 banner-inner">
				<div class="col-md-8 col-sm-7 col-xs-12 banner-jacket">
					<img src="https://dzvexx2x036l1.cloudfront.net/banner_img_ROI.png" alt="Improve your marketing and sales ROI"> 
				</div>
	...
	<section class="section section-second section-second-roi">
		<div class="container">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="section-heading">Get Better ROI On Your Marketing With Outgrow’s Sophisticated Quizzes, Calculators And Assessments. </div>
				...
				<ul>
					...
					<li><i class="material-icons">keyboard_arrow_right</i> <span>The high-conversion rates for quizzes, calculators and assessments means that you get the maximum benefit out of every interactive experience that you create </span> </li>
		...
		<div class="container">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="col-md-10 col-sm-12 col-xs-12 np">
					...
					<img class="rs-show" src="https://dzvexx2x036l1.cloudfront.net/lp-section-six-img_increase-roi.png" alt="Find out the ROI of using Outgrow"> 
					<!-- <ul>
				...
				<img class="rs-hide" src="https://dzvexx2x036l1.cloudfront.net/lp-section-six-img_increase-roi.png" alt="Find out the ROI of using Outgrow"> 
			</div>
		</div>
	</section>
			...
			<div class="col-md-12 col-sm-12 col-xs-12 np">
				<div class="col-md-4 col-sm-4 col-xs-12 np reading-block">
					<div class="img-scaler">
						<img src="https://dzvexx2x036l1.cloudfront.net/lp-reading1_increase-sales.png" alt="How to Build a ROI Calculator"> 
					</div>
				...
				<div class="col-md-4 col-sm-4 col-xs-12 np reading-block">
					<div class="img-scaler">
						<img src="https://dzvexx2x036l1.cloudfront.net/lp-reading3_increase-roi.png" alt="VenturePact case study"> 
					</div>
					<div class="col-md-12 np reading-content">
