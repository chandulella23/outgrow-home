...
@section('title', 'Success Stories | Outgrow')

@section('metaDescription')
	<meta name="description" content="Success stories of companies using Outgrow to grow their business"/>
	<link rel="canonical" href="http://outgrow.co/case-studies.html" />
	<meta property="og:locale" content="en_GB" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="Success Stories | Outgrow" />
	<meta property="og:description" content="Success stories of companies using Outgrow to grow their business" />
	...
	<meta name="twitter:description" content="Success stories of companies using Outgrow to grow their business" />
	<meta name="twitter:title" content="Success Stories | Outgrow" />
	...
	<div class="section-case-study-main">
		<section class="section section-page-heading">
			<div class="container-fluid">
				...
				<h5 class="section-2-subheading">Case studies of companies using Outgrow to grow their business </h5>
			</div>
		</section>
				...
				<section class="section section-whatsNext">
					<div class="container">
						<div class="col-md-12 col-sm-12 col-xs-12 np text-center">
							<div class="section-2-heading">What’s Next? </div>
							<span class="section-subtitle">
								Macroscape now plans to make interactive content an integral part of their marketing strategy. They will be creating more experiences for themselves as well as for their clients in the near future.
							</span>
						</div>
					</div>
				</section>
			...
			<div id="wingman" class="tab-pane tab-pane-wingman fade">
					...
					<div class="container">
						<div class="col-md-12 col-sm-12 col-xs-12 np companyInfo-table">
							...
							<div class="col-md-6 col-sm-6 col-xs-12 np companyInfo-table-cell">
								...
								<h4>Background</h4>
								<p>Thomas Edward, Founder, The Professional Wingman, wanted to expand his audience size, and improve the conversion rates. His goal was to get 1K leads with a month-long campaign. And given the nature of his business, he sure garnered a lot of interest and attention from his target audience. However, he couldn’t hold it or convert it. Traditional marketing tactics were not delivering the desired results. </p>
							</div>
						</div>
					</div>
				</section>
					...
					<div class="container">
						...
						<div class="col-md-12 col-sm-12 col-xs-12 np section-howOutgrowHelped-inner">
							<div class="col-md-4 col-sm-4 col-xs-12 text-center">
								...
								<p>Creating an experience in the Outgrow app is similar to building a powerpoint presentation. The drag and drop, WYSIWYG editor let Thomas create the most complex of experiences without any coding! Thus, he saved on time as well as resources. </p>
							</div>
							<div class="col-md-4 col-sm-4 col-xs-12 text-center">
								...
								<p>The Professional Wingman’s target audience was the smartphone generation. Thus, they wanted the quiz to look flawless on any device - laptop, smartphone or tablet. Outgrow’s 100% responsive, fully customizable templates were a breath of fresh air for the Wingman team. </p>
							</div>
							<div class="col-md-4 col-sm-4 col-xs-12 text-center">
				...
				<section class="section section-results">
					<div class="container">
						...
						<div class="col-md-12 col-sm-12 col-xs-12 np text-center">
							<p>
								Using a quiz as part of their marketing strategy gave The Professional Wingman a lot to bask in- increased traffic, more engagement, more shares, more leads, and even repeat users! They had nearly <b>9609 visits</b> and over <b>2782 leads</b>, plus nearly <b>270 social shares.</b>
							</p>							
						</div>
						<div class="col-md-12 col-sm-12 col-xs-12 np text-center img-wrapper">
