...
@section('content')
		...
		<div class="container">
			...
			<div class="col-md-12 col-sm-12 col-xs-12 banner-inner">
				<div class="col-md-8 col-sm-7 col-xs-12 banner-jacket">
					<img src="https://dzvexx2x036l1.cloudfront.net/banner_img_cal.png" alt="Outgrow's Interactive and Business Calculators"> 
				</div>
				<div class="col-md-4 col-sm-5 col-xs-12 np banner-content">
					...
					<div class="startTrial-outer">
						<label>Build Your First Calculator </label>
			...
			<div class="col-md-12 col-sm-12 col-xs-12 section-premade-temp-inner">
				...
				<div class="premade-template">
					<ul class="pre-temp-cat" id="calc-cats">
						...
						<li>
							<a href="javascript:void(0)" id="HealthFitness" onclick="shuffleCalcs('HealthFitness')">Health & Fitness</a>
						</li>
						<li>
						...
						<li>
							<a href="javascript:void(0)" id="RealEstateConstruction" onclick="shuffleCalcs('RealEstateConstruction')">Real Estate & Construction</a>
						</li>
					</ul>
	...
	<section class="section section-embeds">
		...
		<script>
            ...
            //     }
			// ];
			// window.industries = ['Auto','Education','Finance','Health & Fitness','Real Estate & Construction','Quintessential','Marketing & Advertising']
		...
		<div class="container">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="col-md-10 col-sm-12 col-xs-12 np">
					...
					<img class="rs-show" src="https://dzvexx2x036l1.cloudfront.net/lp-section-six-img_calc.png" alt="Course on Lead Generation with Calculators"> 
					<ul>
			...
			<div class="col-md-12 col-sm-12 col-xs-12 np">
				<div class="col-md-4 col-sm-4 col-xs-12 np reading-block">
					<div class="img-scaler">
						<img src="https://dzvexx2x036l1.cloudfront.net/lp-reading1_calc.png" alt="5 companies using Calculators on Product Hunt"> 
					</div>
				...
				<div class="col-md-4 col-sm-4 col-xs-12 np reading-block">
					<div class="img-scaler">
						<img src="https://dzvexx2x036l1.cloudfront.net/lp-reading2_calc.png" alt="Why you need an ROI Calculator on your Website"> 
					</div>
					<div class="col-md-12 np reading-content">
