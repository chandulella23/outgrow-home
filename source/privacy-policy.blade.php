...
@section('content')
	<section class="section section-services">
		<div class="container res-container">
			...
			<ul>
				<li class="li-style">
					Your responses are owned by the calculator or interactive experience creator. It is up to the calculator or interactive experience creator how they use these responses. All responses are anonymous unless you have provided your user data.
				</li>
				<li class="li-style">
					You may be asked for your email address and/or other personally-identifying information in connection with tracking scores, capturing leads, or presenting offers. Outgrow does not use this information other than to display or provide it to the calculator or interactive experience creator.
				</li>
			</ul>
			...
			<ul>
				...
				<li class="li-style">
					attempt to access Outgrow Services by means other than currently available;
				</li>
				<li class="li-style">
					scrape Outgrow Services or Content;
				</li>
				<li class="li-style">
					violate the intellectual property or personal privacy rights of others, causing harm to others, or violating any criminal laws where Outgrow has a physical location
				</li>
			</ul>
			...
			<p>
			<p>More details about our global privacy policy can be <a href="{{ $page->baseUrl }}/global-data-privacy-policy" class="text-red">found here </a></p>
			<p>More information about our cookie policy can be <a href="{{ $page->baseUrl }}/cookies-privacy-policy" class="text-red">found here </a></p>
