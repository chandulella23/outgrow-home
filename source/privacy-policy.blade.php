...
@section('content')
	<section class="section section-services">
		<div class="container res-container">
			...
			<p>
			<p>More details about our global privacy policy can be found <a href="{{ $page->baseUrl }}/global-data-privacy-policy" class="text-red">here </a></p>
			<p>More information about our cookie policy can be found <a href="{{ $page->baseUrl }}/cookies-privacy-policy" class="text-red">here </a></p>
