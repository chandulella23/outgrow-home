...
@section('content')
	<section class="section section-services">
		<div class="container res-container">
			...
			<h4 class="Privacy-subheading">Fees & payments</h4>
			<p>
