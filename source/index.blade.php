		...
		<div class="container mobile-container">
			<div class="col-xs-12 col-sm-12 col-md-12 np rs-hide text-center">
				<div class="img-wrapper">
					...
					<img class="scrollimg1 abl"  src="images/clients-logos/abl.png" />
					...
					<img class="scrollimg1 abl"  src="images/clients-logos/ladder.png" />
	...
	<div class="col-md-12 col-sm-12 col-xs-12 text-center np case-breathers case-breathers-imgRight">
		<div class="container  custom-container mobile-container">
			...
			<div class="case-breathers-rightSide new-yk">
				...
				<a href="http://resources.outgrow.co/top-viral-calculators" target="_blank" class="btn btn-readmore space">Read more<i class="material-icons">arrow_forward</i></a>
			</div>
