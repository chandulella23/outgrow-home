		...
		<div class="col-xs-12 col-sm-12 np">
			...
			<div class="col-xs-12 col-sm-10 footer-link mk-animate-element fade-in">
				...
				<div class="footer-img2 col-xs-6 col-sm-3">
					<div class="col-xs-12 np"><img class="scrollimg" data-scroll-img="//dzvexx2x036l1.cloudfront.net/res1.jpg" src="" alt="Resources" /></div>
				...
				<div class="footer-img2 col-xs-6 col-sm-3">
					<div class="col-xs-12 np"><img class="scrollimg" data-scroll-img="//dzvexx2x036l1.cloudfront.net/footer5.jpg" src="" alt="Resources" /></div>
					<div class="col-xs-12 np footer-img-text">
				...
				<div class="footer-img2 col-xs-6 col-sm-3">
					<div class="col-xs-12 np"><img class="scrollimg" data-scroll-img="//dzvexx2x036l1.cloudfront.net/res3.jpg" src="" alt="Resources" /></div>
					<div class="col-xs-12 np footer-img-text">
				...
				<div class="footer-img2 col-xs-6 col-sm-3">
					<div class="col-xs-12 np"><img class="scrollimg" data-scroll-img="//dzvexx2x036l1.cloudfront.net/res4.jpg" src="" alt="Resources" /></div>
					<div class="col-xs-12 np footer-img-text">
				...
				<div class="footer-img2 col-xs-6 col-sm-3">
					<div class="col-xs-12 np"><img class="scrollimg" data-scroll-img="//dzvexx2x036l1.cloudfront.net/footer7.jpg" src="" alt="Resources" /></div>
					<div class="col-xs-12 np footer-img-text">
				...
				<div class="footer-img2 col-xs-6 col-sm-3">
					<div class="col-xs-12 np"><img class="scrollimg" data-scroll-img="//dzvexx2x036l1.cloudfront.net/res7.jpg" src="" alt="Resources" /></div>
					<div class="col-xs-12 np footer-img-text">
				...
				<div class="footer-img2 col-xs-6 col-sm-3">
					<div class="col-xs-12 np"><img class="scrollimg" data-scroll-img="//dzvexx2x036l1.cloudfront.net/res8.jpg" src="" alt="Resources" /></div>
					<div class="col-xs-12 np footer-img-text">
						<a href="http://resources.outgrow.co/courses/lead-generation-with-calculators/">Lead Generation With Interactive Calculators</a>
					</div>
				</div>
				<div class="footer-img2 col-xs-6 col-sm-3">
					<div class="col-xs-12 np"><img class="scrollimg" data-scroll-img="//dzvexx2x036l1.cloudfront.net/res9.jpg" src="" alt="Resources" /></div>
					<div class="col-xs-12 np footer-img-text">
