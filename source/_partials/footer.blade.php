<section class="section section-14" id="footer">
	<div class="container">
		<div class="col-xs-12 col-sm-12 np">
			...
			<div class="col-xs-12 col-sm-9 footer-link mk-animate-element fade-in">
				<h4 class="footer-img2text col-xs-12">Resources</h4>
				<div class="footer-img2 col-xs-6 col-sm-3">
					<div class="col-xs-12 np"><img class="scrollimg" data-scroll-img="//dzvexx2x036l1.cloudfront.net/res1.jpg" src="" /></div>
				...
				<div class="footer-img2 col-xs-6 col-sm-3">
					<div class="col-xs-12 np"><img class="scrollimg" data-scroll-img="//dzvexx2x036l1.cloudfront.net/footer5.jpg" src="" /></div>
					<div class="col-xs-12 np footer-img-text">
				...
				<div class="footer-img2 col-xs-6 col-sm-3">
					<div class="col-xs-12 np"><img class="scrollimg" data-scroll-img="//dzvexx2x036l1.cloudfront.net/res3.jpg" src="" /></div>
					<div class="col-xs-12 np footer-img-text">
				...
				<div class="footer-img2 col-xs-6 col-sm-3">
					<div class="col-xs-12 np"><img class="scrollimg" data-scroll-img="//dzvexx2x036l1.cloudfront.net/res4.jpg" src="" /></div>
					<div class="col-xs-12 np footer-img-text">
				...
				<div class="footer-img2 col-xs-6 col-sm-3">
					<div class="col-xs-12 np"><img class="scrollimg" data-scroll-img="//dzvexx2x036l1.cloudfront.net/footer7.jpg" src="" /></div>
					<div class="col-xs-12 np footer-img-text">
				...
				<div class="footer-img2 col-xs-6 col-sm-3">
					<div class="col-xs-12 np"><img class="scrollimg" data-scroll-img="//dzvexx2x036l1.cloudfront.net/res7.jpg" src="" /></div>
					<div class="col-xs-12 np footer-img-text">
				...
				<div class="footer-img2 col-xs-6 col-sm-3">
					<div class="col-xs-12 np"><img class="scrollimg" data-scroll-img="//dzvexx2x036l1.cloudfront.net/res8.jpg" src="" /></div>
					<div class="col-xs-12 np footer-img-text">
						<a href="http://resources.outgrow.co/courses/lead-generation-with-calculators/">Lead Generation With Interactive Calculators</a>
					</div>
				</div>
				<div class="footer-img2 col-xs-6 col-sm-3">
					<div class="col-xs-12 np"><img class="scrollimg" data-scroll-img="//dzvexx2x036l1.cloudfront.net/res9.jpg" src="" /></div>
					<div class="col-xs-12 np footer-img-text">
			...
			<div class="col-xs-12 col-sm-1 footer-link badge-g2crowd">
				<img class="g2crowd"  src="images/badge_g2crowd.svg">
			</div>
		</div>
