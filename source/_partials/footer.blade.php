	...
	<div class="container">
		<div class="col-xs-12 col-sm-12 np">
			...
			<div class="col-xs-12 col-sm-5 footer-link mk-animate-element fade-in hide">
				...
				<div class="scrollimg footer-img col-xs-6 col-sm-6"><img data-scroll-img="//dzvexx2x036l1.cloudfront.net/footer1.jpg" src="" alt="Our Live Calculators footer image" /></div>
				<div class="scrollimg footer-img col-xs-6 col-sm-6"><img data-scroll-img="//dzvexx2x036l1.cloudfront.net/footer2.jpg" src="" alt="Our Live Calculators footer image" /></div>
	...
	<div class="container">
		<div class="col-xs-12 col-sm-12 np">
			...
			<!-- <div class="col-xs-12 col-sm-5 footer-link">
				...
				<div class="scrollimg footer-img col-xs-6 col-sm-6"><img data-scroll-img="//dzvexx2x036l1.cloudfront.net/footer2.jpg" src="" /></div>
				<div class="scrollimg footer-img col-xs-6 col-sm-6"><img data-scroll-img="//dzvexx2x036l1.cloudfront.net/footer4.jpg" src="" /></div>
				<div class="scrollimg footer-img col-xs-6 col-sm-6"><img data-scroll-img="//dzvexx2x036l1.cloudfront.net/footer3.jpg" src="" /></div>
			</div> -->
			<div class="col-xs-12 col-sm-2 footer-link">
				<h4 class="footer-img2text col-xs-12">eBooks</h4>
				<div class="footer-img2 col-xs-6 col-sm-12">
					<a href="https://get.outgrow.co/interactive-content-marketing-for-digital-agencies/?utm_source=footer">
				...
				<div class="footer-img2 col-xs-6 col-sm-12 ebook2">
					<a href="https://get.outgrow.co/guide-to-building-viral-quizzes-and-calculators/?utm_source=footer">
			...
			<div class="col-xs-12 col-sm-2 footer-link">
				<h4 class="footer-img2text col-xs-12">Tools</h4>
				<div class="footer-img2 col-xs-6 col-sm-12">
					<a href="https://influencers.outgrow.us/roi-of-outgrow/?utm_source=footer">
						...
						<div class="col-xs-12 np footer-img-text">							
							<span>Find the ROI of using Outgrow with this Interactive Calculator</span>
						</div>
					</a>
				</div>
				<div class="footer-img2 col-xs-6 col-sm-12 tools2">
					<a href="https://outgrow.co/idea-generation/?utm_source=footer">
						...
						<div class="col-xs-12 np footer-img-text">						
							<span>Generate Ideas for Quizzes and Calculators</span>
						</div>
					</a>
				</div>
			</div>
			<div class="col-xs-12 col-sm-4 footer-link">
				<h4 class="footer-img2text col-xs-12">From our blog</h4>
				<div class="footer-img2 col-xs-6 col-sm-6">
					<a href="https://outgrow.co/blog/top-10-interactive-quizzes-calculators-2017/?utm_source=footer">
						...
						<div class="col-xs-12 np footer-img-text">						
							<span>Highest-performing Interactive Quizzes and Calculators</span>
						</div>
					</a>
				</div>
				<div class="footer-img2 col-xs-6 col-sm-6">
					<a href="https://outgrow.co/blog/interactive-content-engagement-tips/?utm_source=footer">
						...
						<div class="col-xs-12 np footer-img-text">							
							<span>How to Make Quizzes and Calculators Engaging</span>
						</div>
					</a>
				</div>
				<div class="footer-img2 col-xs-6 col-sm-6">
					<a href="https://outgrow.co/blog/get-paid-for-your-pad-interactive-marketing-success-story/?utm_source=footer">
						...
						<div class="col-xs-12 np footer-img-text">						
							<span>Get Paid for your Pad: Interactive Marketing Success Story</span>
						</div>
					</a>
				</div>
				<div class="footer-img2 col-xs-6 col-sm-6">
					<a href="https://outgrow.co/blog/how-an-interactive-calculator-generated-11592-qualified-leads/?utm_source=footer">
		...
		<div class="col-xs-12 np footer-social hide">
			<ul>
				<!-- <li><a href="https://www.facebook.com/OutgrowCo/?utm_source=footer">Facebook</a></li>
				<li><a href="https://www.linkedin.com/company/outgrow.co/?utm_source=footer">Linkedin</a></li>
				<li><a href="https://twitter.com/outgrowco/?utm_source=footer">Twitter</a></li>-->
			...
			<div class="footer-copyright">
				<i class="material-icons">copyright</i>
				<span>Copyright 2019</span>
				<img class="scrollimg" data-scroll-img="https://dzvexx2x036l1.cloudfront.net/outgrow_logo_grey.svg" src="https://dzvexx2x036l1.cloudfront.net/outgrow_logo_grey.svg" />
