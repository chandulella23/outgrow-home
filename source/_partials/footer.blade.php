	...
	<div class="container">
		<div class="col-xs-12 col-sm-12 np">
			...
			<div class="col-xs-12 col-sm-5 footer-link mk-animate-element fade-in hide">
				...
				<div class="footer-img col-xs-6 col-sm-6"><img src="/assets/images/footer1.jpg" /></div>
				<div class="footer-img col-xs-6 col-sm-6"><img src="/assets/images/footer2.jpg" /></div>
				<div class="footer-img col-xs-6 col-sm-6"><img src="/assets/images/footer4.jpg" /></div>
				<div class="footer-img col-xs-6 col-sm-6"><img src="/assets/images/footer3.jpg" /></div>
			</div>
			<div class="col-xs-12 col-sm-10 footer-link mk-animate-element fade-in">
				...
				<div class="footer-img2 col-xs-6 col-sm-3">
					<div class="col-xs-12 np"><img src="/assets/images/res1.jpg" /></div>
				...
				<div class="footer-img2 col-xs-6 col-sm-3">
					<div class="col-xs-12 np"><img src="/assets/images/footer5.jpg" /></div>
					<div class="col-xs-12 np footer-img-text">
				...
				<div class="footer-img2 col-xs-6 col-sm-3">
					<div class="col-xs-12 np"><img src="/assets/images/res3.jpg" /></div>
					<div class="col-xs-12 np footer-img-text">
				...
				<div class="footer-img2 col-xs-6 col-sm-3">
					<div class="col-xs-12 np"><img src="/assets/images/res4.jpg" /></div>
					<div class="col-xs-12 np footer-img-text">
				...
				<div class="footer-img2 col-xs-6 col-sm-3">
					<div class="col-xs-12 np"><img src="/assets/images/footer7.jpg" /></div>
					<div class="col-xs-12 np footer-img-text">
				...
				<div class="footer-img2 col-xs-6 col-sm-3">
					<div class="col-xs-12 np"><img src="/assets/images/res7.jpg" /></div>
					<div class="col-xs-12 np footer-img-text">
		...
		<div class="col-xs-12 np footer-social">
			...
			<div class="footer-copyright">
				...
				<a style="display:none;" href="https://trustlogo.com/install/index5.html?certificatename=Comodo-SSL-Wildcard" target="_blank"><img class="footer-img-2 rs-hide-mb" src="/assets/images/comodo_secure.png" /></a>
			</div>
		</div>
	</div>
</section>