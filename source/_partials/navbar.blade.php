	...
	<div class="navbar-header">
	 ...
	 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		<ul class="nav navbar-nav navbar-right" id="navlist">
			...
			<li class="dropdown">
				<a href="javascript:void(0);" onclick="callGA('USECASE')" class="params" id="nav-examples">Get Inspired <i class="material-icons">arrow_drop_down</i></a>
				<div class="dropdown-content">
					...
					<div class="drop-sub-menu">
						...
						<div class="dropdown-sub-content">
							<a href="{{ $page->baseUrl }}/case-studies#tag" class="active">TAG </a>
							<a href="{{ $page->baseUrl }}/case-studies#getPaid" class="active">Get Paid Your Pad </a>
							<a href="{{ $page->baseUrl }}/case-studies#vp" class="active">VenturePact </a>
							<a href="{{ $page->baseUrl }}/case-studies#macroscape" class="active">Macroscape </a>
						</div>
					</div>
				</div>
			</li>
