...
@section('content')
		...
		<div class="container mobile-container">
			<div class="col-xs-12 col-sm-12 col-md-6 section-f1-left">
				...
				<div class="secf1-test mk-animate-element left-to-right">
				  ...
				  <span class="mk-animate-element right-to-left">
					<!-- <i class="material-icons">format_paint</i> -->
					<span class="span-style">Templates are optimized through many A/B tests and usually see over 40% conversion rate.</span>
				</span>
			</div>
			<div class="col-xs-12 col-sm-12 col-md-6 section-f1-right rs-show">
				<div class="col-xs-12 col-sm-12 slider-sa">
	...
	<section class="section section-17">
		<div class="container img-container-right mobile-container">
			<div class="col-xs-12 col-sm-12 col-md-7 np rs-hide ">
				<img src="{{ $page->baseUrl }}/images/feature-complexFormulas-01.jpg" class="sec17-2-1 mk-animate-element left-to-right box-shadow" />
				<img class="sec17-2 mk-animate-element left-to-right box-shadow" src="{{ $page->baseUrl }}/images/feature-complexFormulas-02.jpg" />
			</div>
					...
					<div class="rs-show">
						<div class="swiper-container  mk-animate-element scale-up rs-show">
							...
							<div class="swiper-slide swiper-slide-active">
								<img src="{{ $page->baseUrl }}/images/features-graphsCharts-01.jpg" alt="" class="qode-lazy-image">
							</div>
							<div class="swiper-slide swiper-slide-next">
								<img src="{{ $page->baseUrl }}/images/features-graphsCharts-02.jpg" alt="" class="qode-lazy-image">
							</div>
							<div class="swiper-slide swiper-slide-next">
								<img src="{{ $page->baseUrl }}/images/features-graphsCharts-03.jpg" alt="" class="qode-lazy-image">
							</div>
							<div class="swiper-slide swiper-slide-next">
								<img src="{{ $page->baseUrl }}/images/features-graphsCharts-04.jpg" alt="" class="qode-lazy-image">
							</div>
						</div>
							<!-- Add Pagination -->
						</div>
		...
		<div class="container img-container-right mobile-container np">
			...
			<div class="col-xs-12 col-sm-12 col-md-12 np rs-hide">
				<div class="col-md-6 img-pad-left">
					<img src="{{ $page->baseUrl }}/images/analytics02.jpg" class="box-shadow" />
				</div>
				<div class="col-md-6 img-pad-right">
				<img src="{{ $page->baseUrl }}/images/feature-analytics01.jpg" class="box-shadow" />
				</div>
			</div>
			<div class="col-xs-12 col-sm-12 col-md-12 rs-show np section-f4-right">
				<img src="{{ $page->baseUrl }}/images/analytics02.jpg" class="col-md-6 np box-shadow w100" />
				<img src="{{ $page->baseUrl }}/images/feature-analytics01.jpg" class="col-md-6 np box-shadow w100" />
			</div>
		</div>
	</section>
	...
	<!-- Feature page section 10 start-->
	<section class="section section-6 sec-integration">
		<div class="container">
			<div class="col-md-12 np mk-animate-element scale-up">
