		...
		<div class="container">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="col-md-10 col-sm-10 col-xs-12">
					...
					<img class="rs-show" src="images/lp-section-six-img_survey.png" alt="lp-section-six-img_survey image"> 
					<ul>
				...
				<img class="rs-hide" src="images/lp-section-six-img_survey.png" alt="lp-section-six-img_survey image"> 
			</div>
		</div>
	</section>
			...
			<div class="col-md-12 col-sm-12 col-xs-12 np">
				<div class="col-md-4 col-sm-4 col-xs-12 np reading-block">
					<div class="img-scaler">
						<img src="images/lp-reading1_survey.png" alt="lp-reading1_survey image"> 
					</div>
				...
				<div class="col-md-4 col-sm-4 col-xs-12 np reading-block">
					<div class="img-scaler">
						<img src="images/lp-reading2_survey.png" alt="lp-reading2_survey image"> 
					</div>
					<div class="col-md-12 np reading-content">
				...
				<div class="col-md-4 col-sm-4 col-xs-12 np reading-block">
					<div class="img-scaler">
						<img src="images/lp-reading3_survey.png" alt="lp-reading3_survey image"> 
					</div>
					<div class="col-md-12 np reading-content">
