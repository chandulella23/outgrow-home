	...
	<section class="section section-banner section-banner-sales">
		<div class="container">
			<div class="col-md-12 col-sm-12 col-xs-12 text-center">
				<h1 class="main-heading">Increase your Online Sales with Interactive Recommendations, Quizzes, Calculators and Assessments</h1>
			</div>
	...
	<section class="section section-second section-second-sales">
		<div class="container">
			<div class="col-md-12 col-sm-12 col-xs-12 np">
				<div class="section-heading">Generate more sales with Outgrow’s interactive content tools (recommendations, quizzes, calculators, etc.) </div>
	...
	<section class="section section-quotes section-quotes_increase-sales">
		<div class="container">
			<div class="col-md-12 col-sm-12 col-xs-12 np section-quotes-border">
				<blockquote><span class="quote-left1">“</span>If you are currently generating leads using other products, you will see a slight dip in the volume of leads you gain but, a significantly higher yield in the quality of the leads. All in all, you would much rather call 10 and make 8 sales rather than calling 100 to make the same 8 sales. It's a winner. <span class="quote-right1">“</span></blockquote>
