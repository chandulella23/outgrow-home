...
@section('title', 'Increase Ecommerce Sales with Product Recommendations | Outgrow')
...
@section('metaDescription')
	...
	<meta property="og:description" content="Provide a unique shopping experiences to your online store visitors and increase sales with interactive product recommendations." />
	...
	<meta name="twitter:description" content="Provide a unique shopping experiences to your online store visitors and increase sales with interactive product recommendations." />
	<meta name="twitter:title" content="Increase Ecommerce Sales with Product Recommendations | Outgrow" />
		...
		<div class="container-fluid">
			<div class="col-md-12 col-xs-12 col-sm-12 section-1-left text-center">
				<div class="section1-left-cellnoab">
					...
					<h1 class="section1-firstheadnoab">
						<span class="">Increase Ecommerce Sales with Interactive Product Recommendations</span>
					</h1>
				...
				<div class="video-img-wrapper">
					<div class="overflow-hidden">
						<div class="video-img-inner video-img-inner-mob" data-toggle="modal" data-target="#video-modal">
							<img alt="video thumbnail image" class="video-img" src="{{ $page->baseUrl }}/images/video-thumbnail-ecomm.jpg" />
				...
				<div class="video-img-wrapper">
					<div class="overflow-hidden">
						<div class="video-img-inner video-img-inner-res" onclick="changeHeightRes()">
							<img alt="video thumbnail image" class="video-img" src="{{ $page->baseUrl }}/images/video-thumbnail-ecomm.jpg" data-src="{{ $page->baseUrl }}/images/video-thumbnail-ecomm.jpg" />
							<span class="img-overlay"></span>
							<span class="video-playIcon">
								<span class="inside-circle"><i class="material-icons">play_arrow</i></span>
							</span>
			...
			<script>
				document.getElementsByClassName("video-playIcon")[0].onclick = function () {
					...
					document.getElementsByClassName("outgrow-video-mob")[0].src = 'https://www.youtube.com/embed/Sl3G0nsbemQ?vq=hd720&amp;rel=0&amp;controls=0&amp;showinfo=0;autoplay=1&amp;iv_load_policy=3'
				}
				function btnclose() {
					document.getElementsByClassName("outgrow-video-mob")[0].src = 'https://www.youtube.com/embed/Sl3G0nsbemQ?vq=hd720&amp;rel=0&amp;controls=0&amp;showinfo=0;autoplay=0&amp;iv_load_policy=3'
				}
				// function changeHeightRes () {
				// 	console.log('Res');
				// 	window.location.replace('#bfrVid')
				// 	document.getElementsByClassName("video-img-inner-res")[0].innerHTML = "<div class='embed-responsive embed-responsive-16by9'><iframe class='outgrow-video' src='https://www.youtube.com/embed/Sl3G0nsbemQ?vq=hd720&amp;rel=0&amp;controls=0&amp;showinfo=0;autoplay=1&amp;iv_load_policy=3' frameborder='0' allowfullscreen></iframe></div>";
				...
				function changeHeightWeb1 () {
					console.log('Tab');
					window.location.replace('#bfrVid')
					document.getElementById("him1").innerHTML = "<div class='embed-responsive embed-responsive-16by9'><iframe class='outgrow-video' src='https://www.youtube.com/embed/Sl3G0nsbemQ?vq=hd720&amp;rel=0&amp;controls=0&amp;showinfo=0;autoplay=1&amp;iv_load_policy=3' frameborder='0' allowfullscreen></iframe></div>";
				...
				// 	console.log('Tab');
				// 	window.location.replace('#bfrVid')
				// 	document.getElementById("him1-xl").innerHTML = "<div class='embed-responsive embed-responsive-16by9'><iframe class='outgrow-video' src='https://www.youtube.com/embed/Sl3G0nsbemQ?vq=hd720&amp;rel=0&amp;controls=0&amp;showinfo=0;autoplay=1&amp;iv_load_policy=3' frameborder='0' allowfullscreen></iframe></div>";
			...
			<div class="col-md-12 col-sm-12 col-xs-12 np">
				<div class="col-md-4 col-sm-4 col-xs-12 np reading-block">
					<div class="img-scaler">
						<img src="{{ $page->baseUrl }}/images/ecom-reading1.png" alt="[Ebook] 25 List Building Strategies to Amplify your Ecommerce Brand">
					</div>
					<div class="col-md-12 np reading-content">
						<h4>[Ebook] 25 List Building Strategies to Amplify your Ecommerce Brand</h4>
						<p>Generating traffic and leads is the biggest marketing challenge for 60% of marketers. In this ebook, read about 25 innovative list building strategies for ecommerce to help you meet this challenge! </p>
						<a href="https://get.outgrow.co/ebook-ecommerce-list-building-strategies/" target="_blank" class="btn btn-readmore-link">Read more <i class="material-icons">keyboard_arrow_right</i></a>
					</div>
				</div>
				<div class="col-md-4 col-sm-4 col-xs-12 np reading-block">
					<div class="img-scaler">
						<img src="{{ $page->baseUrl }}/images/ecom-reading2.png" alt="The Ultimate Conversion Rate Optimization Checklist for Ecommerce">
					</div>
					<div class="col-md-12 np reading-content">
						<h4>The Ultimate Conversion Rate Optimization Checklist for Ecommerce </h4>
						<p>75+ CRO hacks. This lineup takes you through the minutest of details of ecommerce conversions. Simply tick 'em all off and you're sorted! </p>
						<a href="https://get.outgrow.co/ultimate-ecommerce-cro-checklist/" target="_blank" class="btn btn-readmore-link">Read more <i class="material-icons">keyboard_arrow_right</i></a>
					</div>
				</div>
				<div class="col-md-4 col-sm-4 col-xs-12 np reading-block">
					<div class="img-scaler">
						<img src="{{ $page->baseUrl }}/images/ecom-reading3.png" alt="Why Product Recommendation Quizzes Drive Ecommerce Sales in 2018">
					</div>
					<div class="col-md-12 np reading-content">
						<h4>Why Product Recommendation Quizzes Drive Ecommerce Sales in 2018 </h4>
						<p>Product recommendations engage your website visitors by helping them find the EXACT products they're looking for. Find out why product recommendation quizzes work and why every ecommerce store needs to have one. </p>
						<a href="https://outgrow.co/blog/product-recommendation-quizzes-drive-ecommerce-sales" target="_blank" class="btn btn-readmore-link">Read more <i class="material-icons">keyboard_arrow_right</i></a>
					</div>
				</div>
			</div>
			<div class="col-md-12 col-sm-12 col-xs-12 np">			
				<div class="col-md-4 col-sm-4 col-xs-12 np reading-block">
					<div class="img-scaler">
						<img src="{{ $page->baseUrl }}/images/ecom-reading4.png" alt="From a Bookselling Website to an Ecommerce Giant - A Critical View of Amazon's Growth Story"> 
					</div>
					<div class="col-md-12 np reading-content">
						<h4>From a Bookselling Website to an Ecommerce Giant - A Critical View of Amazon's Growth Story </h4>
						<p>Riding on an $800 billion net worth, the Amazon empire is headed for an upward growth. Take a look at the Amazon growth story to understand why we think 'Amazon' should be spelled as A-M-A-Z-I-N-G. </p>
						<a href="https://outgrow.co/blog/amazon-growth-story" target="_blank" class="btn btn-readmore-link">Read more <i class="material-icons">keyboard_arrow_right</i></a>
					</div>
				</div>
				<div class="col-md-4 col-sm-4 col-xs-12 np reading-block">
					<div class="img-scaler">
						<img src="{{ $page->baseUrl }}/images/ecom-reading5.png" alt="10 Must Read Books for a Thriving Ecommerce Business"> 
					</div>
					<div class="col-md-12 np reading-content">
						<h4>10 Must Read Books for a Thriving Ecommerce Business </h4>
						<p>Looking for relevant insights to build an ecommerce business from scratch? Or digging resources to take your e-store to the next stage? Check out this list of 10 books every ecommerce marketer should read. </p>
						<a href="https://outgrow.co/blog/10-must-read-books-ecommerce-business" target="_blank" class="btn btn-readmore-link">Read more <i class="material-icons">keyboard_arrow_right</i></a>
					</div>
				</div>
				<div class="col-md-4 col-sm-4 col-xs-12 np reading-block">
					<div class="img-scaler">
						<img src="{{ $page->baseUrl }}/images/ecom-reading6.png" alt="9 Reasons Why Your E-store Visitors Don't Convert & What You Can Do About It"> 
					</div>
					<div class="col-md-12 np reading-content">
						<h4>9 Reasons Why Your E-store Visitors Don't Convert & What You Can Do About It </h4>
						<p>The average conversion rate in the ecommerce industry is just 3%. Which means that, 97% of visitors bail out on you. In this post, we discuss 9 reasons which your visitors don't convert and what you can do about it. </p>
						<a href="https://outgrow.co/blog/9-reasons-why-your-estore-visitors-dont-convert-and-what-you-can-do-about-it" target="_blank" class="btn btn-readmore-link">Read more <i class="material-icons">keyboard_arrow_right</i></a>
					</div>
				</div>
			</div>
		</div>
