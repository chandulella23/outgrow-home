...
@section('content')
	<section class="section section-services">
		<div class="container res-container">
			...
			<p>
				However, where applicable, Outgrow seeks to exceed these standards to ensure compliance with stringent local laws, such as the European Union’s Data Protection Directive (95/46/EC) (as implemented by local law).
			</p>
			<h4 class="Privacy-subheading">EU-U.S. and Swiss-U.S. Privacy Shield Frameworks</h4>
			<p>
				...
				policy, Outgrow complies with the EU-U.S. Privacy Shield Framework and Swiss-U.S. Privacy
				Shield Framework (the “Privacy Shield”) as adopted and set forth by the U.S. Department of
				Commerce regarding the processing of personal data. Outgrow commits to adhere to and has
				...
				https://www.privacyshield.gov and https://www.privacyshield.gov/list, respectively.
			</p>
			...
			<p>
				<b>For all contact or data forms hosted on Outgrow, if required by the user and the law of the concerned geography, the user is allowed to add opt-in widgets with clear data privacy statements for end user’s reference. When required, opt-out widgets can also be added by the user. </b>
			</p>
			<p>
			...
			<ul>
				...
				<li class="li-style alpha">
					a. In those cases in which Outgrow collaborates with third parties, who process PII on behalf of Outgrow, in order to provide the services and, in particular, for the operation of the platform, as well as for the storing of the PII, in which case those third parties are required to maintain at least the same level of confidentiality that we maintain for such PII,  and to implement other adequate technical and organisational measures to prevent the unauthorized or illegal processing of the information and the accidental loss, destruction or impairment of the same; or <br/>
					b. When it is required by a competent authority in the exercise of its duties (for example in order to investigate, prevent or take action regarding illegal activities); or <br/>
				...
				<li class="li-style">
					Implementing and maintaining the adequate technical and organisational measures to prevent the unauthorized or illegal processing of the PII and, in particular, of the data, as well as the accidental loss, destruction or impairment.  
				</li>
				<li class="li-style">
					All users have the option to notify their visitors of the data that would be gathered during their interaction and the visitor can choose to accept or reject this.
				</li>
			</ul>
			...
			<ul>
				...
				<li class="li-style">
					Where required by local law, obtain explicit consent from individuals, prior to the collection of sensitive information (e.g. race, ethnic origin, health details, sexual orientation etc.); and
				</li>
			</ul>
			<p>
