...
<section class="section intercom test-engage-1">
		<div class="container">
			<div class="col-md-12 col-sm-12 col-xs-12 text-center inter1">
			   <h1 class="chatbot-heading bot-head">Revolutionise Your Workplace With Engaging HR Surveys</h1>
		  ...
		  <div class="interbot-content">
			...
			<span class="lead-form-btn">
                ...
                Try Outgrow HR Surveys For Free
				</a>
		...
		<div class="social-media-section">
			...
			<iframe src="https://premade.outgrow.us/premadeJob_Sat_survey" frameborder="0"></iframe>
...
<section class="section outgrow-test-block1">
		<div class="container-fluid">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="section-heading text-center">Customise these templates to Automate Feedback Collection, Make Better Decisions, and Increase Workplace Efficiency</div>
			</div>
...
<section class="section sec-lang-test section-whyMerticsAwesome test-back-skyblue">
		<div class="container">
			<div class="section-2-heading bot-head">Why Outgrow Human Resources Templates?</div>	
			<div class="col-md-12 col-sm-12 col-xs-12 np whyMerticsAwesome-inner">
				<div class="col-md-12 col-sm-12 col-xs-12 np whyMerticsAwesome-inner-row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12 np whyMerticsAwesome-inner-right">
						...
						<div class="intercom-para-content"><p class="intercom-para">Choose from over 10 different question types (including multiple select, single select, text input, drop down, numerical slider, opinion scale, rating, date/time picker, and file upload). Automatically trigger multiple outcomes and follow-up emails based on how an employee answers the questions.</p></div>
					</div>
				</div>
				<div class="col-md-12 col-sm-12 col-xs-12 np whyMerticsAwesome-inner-row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12 np whyMerticsAwesome-inner-left ">
						<h3 class="section-subheading bot-heading"><b>Awesome</b> Templates</h3>
						<div class="intercom-para-content"><p class="intercom-para"> Choose from a host of professionally designed <b>Performance Review, Employee Satisfaction, Leadership Effectiveness,</b> and <b>Work/Life Balance</b> survey templates.</p></div>
					</div>
				...
				<div class="col-md-12 col-sm-12 col-xs-12 np whyMerticsAwesome-inner-row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12 np whyMerticsAwesome-inner-right">
						<h3 class="section-subheading bot-heading"><b>Easy</b> to <b>Create</b> and <b>Embed</b></h3>
						<div class="intercom-para-content"><p class="intercom-para">Just copy and paste your questions in the template. Boost engagement by adding pictures, videos, gifs, recordings, captions, and even countdown timers. Embed on multiple platforms and if necessary launch the surveys directly in emails.</p></div>
					</div>
				</div>
				<div class="col-md-12 col-sm-12 col-xs-12 np whyMerticsAwesome-inner-row">
					<div class="col-md-5 col-sm-5 col-xs-12 np whyMerticsAwesome-inner-right rs-show">
					...
					<div class="col-md-6 col-sm-6 col-xs-12 np whyMerticsAwesome-inner-left ">
						...
						<div class="intercom-para-content"><p class="intercom-para">Use Outgrow Analytics to examine all answers and send the results data to any of our 1000+ integration partners. Easily create reports by filtering all data through custom criteria. Export all data to an Excel or Google Doc.</p></div>
					</div>
					<div class="col-md-5 col-sm-5 col-xs-12 np whyMerticsAwesome-inner-right rs-hide">
						<img src="{{ $page->baseUrl }}/images/why-test-4.png" alt="Awesome Analytics" class="whymetricimg-hyt">
