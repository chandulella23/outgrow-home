...
@section('content')
	...
	<section class="section section-1">
		<div class="container-fluid">
			    ...
			    <div class="starter-box billing-grey ">
			        ...
			        <div class="col-md-12 col-sm-12 col-xs-12 np rs-hide billing-grey-bottom" id="essentials_m">
			            <ul class="billing-list">
			                ...
			                <div class="help-tip pricing-helptip">
					        	<i class="material-icons">info_outline</i>
					        	<div class="help-checktip">You can show custom messages, have custom call to actions, use your brand colors & use advanced formulas.</div>
					        </div>
			                </a>
			                </li>
			...
			<div class="col-md-12 col-sm-12 col-xs-12 col-sm-offset-2 np pricing-help hide">
				<span class="billing-plans-help">*All plans come with unlimited templates</span>
			</div>
	...
	<section class="section mk-animate-element scale-up">
		...
		<div class="accordion"><div class="accordion-section">
				...
				<div id="accordion-2" class="accordion-section-content">
					<p>When you sign up, you will be assigned to our Business Premium plan. You will have access to this plan for 15 days. Should you choose to continue with the business plan, you will have to add your payment method.
					</p>
