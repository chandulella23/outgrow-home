	...
	<div class="container">
		<div class="col-xs-12 col-sm-12 np">
			<div class="col-xs-12 col-sm-2 footer-link mk-animate-element fade-in">
				<h4>Overview</h4>
				<ul>
					<li><a href="<?php echo e($page->baseUrl); ?>/why-interactive" onclick="callGA(\'WHYF\')" class="params">Why Interactive Content</a></li>
					<li><a href="<?php echo e($page->baseUrl); ?>/features" onclick="callGA(\'FEATURESF\')" class="params">Features </a></li>
					<li><a href="<?php echo e($page->baseUrl); ?>/examples" onclick="callGA(\'USECASEF\')" class="params">Examples</a></li>
					<li><a href="<?php echo e($page->baseUrl); ?>/pricing" onclick="callGA(\'PRICINGF\')" class="params">Pricing</a></li>
					...
					<li><a href="<?php echo e($page->baseUrl); ?>/privacy-policy" onclick="callGA(\'PRIVACYF\')" class="params">Privacy Policy</a></li>
					<li><a href="<?php echo e($page->baseUrl); ?>/tos" onclick="callGA(\'TERMSF\')" class="params">Terms of Services</a></li>
				</ul>
			</div>
