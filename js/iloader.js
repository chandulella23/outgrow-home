...
og_e.setAttribute("style", "border:2px solid rgb(213,213,213); line-height: 0;");
...
if (iWidth < 786) {
    ...
    var style_node = document.createTextNode("body, html {height: 100%;margin: 0;overflow: hidden;}.fullScreen {z-index:9990;width: 100%;height: 100% !important;position: fixed;top: 0;left: 0;}.hide{display:none;}.height-auto{height: 100vh !important}");
