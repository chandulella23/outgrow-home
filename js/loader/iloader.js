...
if (og_check == 0) {
    ...
    if (iWidth < 786) {
		...
		if(IS_IPHONE){
			...
			var style_node = document.createTextNode("body, html {height: 100%;margin: 0;}.fullScreen {z-index:9990;width: 100%;height: 100% !important;position: fixed;top: 0;left: 0;}.hide{display:none;}.height-auto{height: 100%;}.ovr-hid{overflow: hidden !important;}");
		}
